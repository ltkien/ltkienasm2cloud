...
<body>
    <div id="wrapper">
        ...
        <form action="toysubmit.php" method="post">
            <div class="form">
                <div class="form-group">
                    <label for="toy-name">Toy name</label>
                    <input class="form-control" type="text" name="toy-name" id="toy-name" placeholder="Enter toy's name" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control before-add-btn" type="number" name="toy-quantity" id="toy-quantity" placeholder="Enter quantity" required>
                </div>
                <div class="form-group">
                    <label for="toy-quantity">Description</label>
                    <input class="form-control before-add-btn" type="text" name="toy-description" id="toy-description" placeholder="Enter toy's description" required>
                </div>
