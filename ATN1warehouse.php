    ...
    $query = "select id, toy_name, toy_price, atn_store, toy_quantity, toy_description from toy WHERE atn_store='1' ;";
        ...
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a href="employee.php"><i class="fa fa-dashboard"></i> Dashboard</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active-menu" href="ATN1warehouseS.php">ATN shop 1</a>
                                </li>
                                <li>
            ...
            <div class="header"> 
                <h1 class="page-header">
                    ATN 1 shop warehouse <small>Welcome Boss </small>
                </h1>				
            </div>
        </div>  
        <!-- /. main  -->
